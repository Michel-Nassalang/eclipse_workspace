 ...
 */
package org.xtext.ipsl.mydsl.ide.contentassist.antlr;
...
import org.xtext.ipsl.mydsl.ide.contentassist.antlr.internal.InternalMonDslParser;
import org.xtext.ipsl.mydsl.services.MonDslGrammarAccess;

public class MonDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(MonDslGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MonDslGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalMonDslParser createParser() {
		InternalMonDslParser result = new InternalMonDslParser(null);
