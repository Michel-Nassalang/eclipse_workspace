...
/**
 * This is the item provider adapter for a {@link Enseignement.Departement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepartementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EnseignementPackage.Literals.DEPARTEMENT__NOM,
				 true,
				 false,
				 false,
	...
	protected void addResponsablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Departement_responsable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Departement_responsable_feature", "_UI_Departement_type"),
				 EnseignementPackage.Literals.DEPARTEMENT__RESPONSABLE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EnseignementPackage.Literals.DEPARTEMENT__EMPLOYES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EnseignementPackage.Literals.DEPARTEMENT__EMPLOYES,
